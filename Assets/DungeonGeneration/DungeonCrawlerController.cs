...
public class DungeonCrawlerController : MonoBehaviour
{
    ...
    public static List<Vector2Int> GenerateCave(CaveGenerationData caveData)
    {
        List<DungeonCrawler> dungeonCrawlers = new List<DungeonCrawler>();

        for (int i = 0; i < caveData.numberofCrawlers; i++)
        {
            dungeonCrawlers.Add(new DungeonCrawler(Vector2Int.zero));
        }

        int iterations = Random.Range(caveData.iterationMin, caveData.iterationMax);
